...
This distribution is implicitly defined by the transformation of an initial distribution by a sequence of optimization steps. % into a final approximation.
...
We introduced a variational lower bound on the marginal likelihood of these implicit distributions, which in principle could be used to choose model and training hyperparameters.
...
It does not beat the gold standard of cross-validation
