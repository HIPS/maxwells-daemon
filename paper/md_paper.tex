...
can be interpreted as procedures that generate samples from an nonparametric
approximate posterior distribution.  This variational distribution is implicitly
...
lower bound on the marginal likelihood. We can maximize this bound with respect
