...
%\vskip 0.2in
\begin{center}
\includegraphics[width=\columnwidth]{../experiments/2015_03_03_vary_width/2_num_hidden/vary_widths.pdf}
\vskip -0.1in
...
\emph{Bottom}: Marginal likelihood.}
...
Figure \ref{fig:threshold} shows marginal likelihood estimates as a function of the gradient threshold in the modified SGD algorithm.
...
Because estimating marginal likelihood in high dimensions is known to be hard, 
