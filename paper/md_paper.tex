...
The lower bound is valid no matter which distribution we choose.
...
In this section we show that the marginal likelihood estimate can be used to choose the number of training iterations, and to choose model capacity, without the need for a validation set.
...
Figure \ref{fig:threshold} shows
