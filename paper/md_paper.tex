...
entropy at each iteration can't requires access to the current distribution over parameters.
...
to the optimium. For example the modifiend gradient (and resulting modified Jacobian) could \begin{align}
