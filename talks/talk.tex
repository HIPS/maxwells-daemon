...
\item Further $\mathcal{O}(D)$ approximation using Hessian-vector products
...
\item Gives reasonable estimates
...
\frame[plain]{\frametitle{Limitations of early stopping}
\begin{columns}
\hspace{-1cm}\begin{column}{6cm}
\begin{itemize} 
...
\frame[plain]{\frametitle{Limitations of bound}
\begin{columns}
\hspace{-1cm}\begin{column}{6cm}
\begin{itemize}
